#Задача 8 шашек.
#Вариант сделан с Постарнаковым М.Я.
#На стандартной шахматной доске 8x8 нужно расставить 8 шашек таким образом, чтобы в каждом ряду, в каждом столбце и на каждой из двух диагоналей доски была ровно одна шашка.
